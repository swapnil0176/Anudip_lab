...
public class CarServiceCentre extends CarWashing implements ServiceOffice{
    ...
    String acceptDetails(){//method overloading

        System.out.println("Welcome to Swapnil`s Car Service Center\n" +
    ...
    void acceptDetails(String c_name){// method overloading
    ...
    public void services() {
        ...
        do{
           ...
           System.out.println("Do you have more services");
           ch=sc.next().charAt(0);
        }while(ch=='y' || ch=='Y');
       displayBill();
    }
