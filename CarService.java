...
public abstract class CarService{
    ...
    public String bill="";
    char ch;
    public int getPrice() {return price;}//getter are use to retrieve value

    public void setPrice(int price) {this.price = price;}//setter is use to set value
    ...
    void basicServices(){
        ...
        do {
            ...
            System.out.println("Do have any basic services");
            ch=sc.next().charAt(0);
        }while(ch=='Y' ||ch=='y');
    }
    void engineServices(){
        ...
        do {
            ...
            System.out.println("Do have any engine services");
            ch=sc.next().charAt(0);
        }while(ch=='Y' ||ch=='y');
    }
}
